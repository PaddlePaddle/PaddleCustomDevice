...
void ElementwiseMaxKernel(const Context& dev_ctx,
  ...
  br_device::SupaOpRunner<T, Context> runner(
      dev_ctx, br_device::OP_PARAMS(ElementwiseMax)(), {&x, &y}, {out});
  runner.Run();
...
PD_REGISTER_PLUGIN_KERNEL(
    maximum, SUPA, ALL_LAYOUT, supa::ElementwiseMaxKernel, float) {}
