...
void ElementwiseMinKernel(const Context& dev_ctx,
  ...
  br_device::SupaOpRunner<T, Context> runner(
      dev_ctx, br_device::OP_PARAMS(ElementwiseMin)(), {&x, &y}, {out});
  runner.Run();
...
PD_REGISTER_PLUGIN_KERNEL(
    minimum, SUPA, ALL_LAYOUT, supa::ElementwiseMinKernel, float) {}
