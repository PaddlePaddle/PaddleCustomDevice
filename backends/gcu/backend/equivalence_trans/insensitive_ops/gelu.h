...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, GeluEquivalenceTrans) {
  ...
  if (use_mkldnn || use_cudnn) {
    PADDLE_THROW(
        phi::errors::InvalidArgument("GCU not support mkldnn/cudnn for gelu"));
    return nullptr;
  }
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, GeluGradEquivalenceTrans) {
