...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, LayerNormEquivalenceTrans) {
  ...
  std::vector<int64_t> mean_var_shape2 = {left};
  out_1 = builder::Reshape(out_1, mean_var_shape2);
  out_2 = builder::Reshape(out_2, mean_var_shape2);
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, LayerNormGradEquivalenceTrans) {
  builder::Op input_x = *(map_inputs["X"].at(0));
