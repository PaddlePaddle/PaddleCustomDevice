...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, ReduceSumEquivalenceTrans) {
...
// Ref: Paddle/paddle/fluid/operators/reduce_ops/reduce_sum_op_npu.cc
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, ReduceSumGradEquivalenceTrans) {
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, ReduceMeanEquivalenceTrans) {
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, ReduceMeanGradEquivalenceTrans) {
  builder::Op x = *(map_inputs["X"].at(0));
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, ReduceMaxEquivalenceTrans) {
  auto x = *(map_inputs["X"].at(0));
  auto dim = PADDLE_GET_CONST(std::vector<int>, op->GetAttr("dim"));
  auto reduce_all = PADDLE_GET_CONST(bool, op->GetAttr("reduce_all"));
  auto keep_dim = PADDLE_GET_CONST(bool, op->GetAttr("keep_dim"));
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, ReduceMinEquivalenceTrans) {
  auto x = *(map_inputs["X"].at(0));
  auto dim = PADDLE_GET_CONST(std::vector<int>, op->GetAttr("dim"));
  auto reduce_all = PADDLE_GET_CONST(bool, op->GetAttr("reduce_all"));
  auto keep_dim = PADDLE_GET_CONST(bool, op->GetAttr("keep_dim"));
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, ReduceProdEquivalenceTrans) {
  auto x = *(map_inputs["X"].at(0));
  auto dim = PADDLE_GET_CONST(std::vector<int>, op->GetAttr("dim"));
  auto reduce_all = PADDLE_GET_CONST(bool, op->GetAttr("reduce_all"));
  auto keep_dim = PADDLE_GET_CONST(bool, op->GetAttr("keep_dim"));
