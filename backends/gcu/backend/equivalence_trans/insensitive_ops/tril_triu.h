...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, TrilTriuEquivalenceTrans) {
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, TrilTriuGradEquivalenceTrans) {
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, TrilEquivalenceTrans) {
  builder::Op input = *(map_inputs["X"].at(0));
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, TrilGradEquivalenceTrans) {
  builder::Op grad_out = *(map_inputs["Out@GRAD"].at(0));
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, TriuEquivalenceTrans) {
  builder::Op input = *(map_inputs["X"].at(0));
...
IMPLEMT_EQUIVALENCE_TRANS_FUNC(
    gcu_builder, op, map_inputs, running_mode, TriuGradEquivalenceTrans) {
  builder::Op grad_out = *(map_inputs["Out@GRAD"].at(0));
