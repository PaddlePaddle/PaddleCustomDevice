...
from .legacy_ir_passes.gcu_conv_add_mul_add_hard_swish_mul_add_fuse import (
...
from .legacy_ir_passes.gcu_conv_bias_activate_fuse import (
    gcu_fuse_conv_bias,
    gcu_fuse_conv_bias_activate,
)
from .legacy_ir_passes.gcu_conv_bn_fuse import (
    gcu_fuse_conv_bn,
...
from .legacy_ir_passes.gcu_conv_bn_hard_swish_fuse import (
    gcu_fuse_depthwise_conv_bn_hard_swish,
)

from .legacy_ir_passes.gcu_dot_bias_fuse import (
    gcu_fuse_dot_bias,
)

from .legacy_ir_passes.gcu_mul_add_fuse import (
    gcu_fuse_mul_add,
)

from .legacy_ir_passes.gcu_sdp_attn_fuse import (
    fused_sdp_attention,
)

from .legacy_ir_passes.gcu_multi_head_attn_fuse import (
    fused_multi_head_attention_pass,
)

from .legacy_ir_passes.gcu_linear_fuse import (
    fused_linear_pass,
)

from .legacy_ir_passes.gcu_conv_transpose_elementwise_add_act_fuse_pass import (
    conv2d_transpose_elementwise_add_relu_fuse_pass,
    conv2d_transpose_elementwise_add_sigmoid_fuse_pass,
)

from .legacy_ir_passes.gcu_conv_transpose_elementwise_add_fuse_pass import (
    conv2d_transpose_elementwise_add_fuse_pass,
)

from .legacy_ir_passes.gcu_conv_depthwise_elementwise_add_fuse_pass import (
    conv2d_depthwise_elementwise_add_fuse_pass,
)

from .legacy_ir_passes.gcu_conv_elementwise_add_fuse_pass import (
