...
class TestInstanceNormOp(OpTest):
    ...
    def test_check_output(self):
        self.check_output_with_place(self.place, atol=1e-05)

    def test_check_grad(self):
        self.check_grad_with_place(self.place, ["X", "Scale", "Bias"], "Y")
...
class TestElasticNormOp(unittest.TestCase):
    def init_test_case(self):
        self.epsilon = 1e-05
        self.places = [core.CPUPlace(), core.CustomPlace("gcu", 0)]
