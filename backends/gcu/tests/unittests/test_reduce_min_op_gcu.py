...
class TestReduceMinOpMultiAxises(TestReduceMinOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
...
class TestReduceAll(TestReduceMinOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
...
class TestReduceMinOpWithOutDtype_int32(TestReduceMinOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
...
class TestReduceMinOpWithOutDtype_fp16(TestReduceMinOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
...
class TestReduceMinOpWithOutDtype_fp32(TestReduceMinOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
