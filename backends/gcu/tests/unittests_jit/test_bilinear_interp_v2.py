...
def test_bilinear_interp_v2_1():
    ...
    test1.run(
        feed=[data], size=[1, 1], mode="bilinear", align_corners=True, align_mode=1
    )
...
def test_bilinear_interp_v2_2():
    ...
    test2.run(
        feed=[data], size=[12, 12], mode="bilinear", align_corners=True, align_mode=1
    )
...
def test_bilinear_interp_v2_3():
    ...
    test3.run(
        feed=[data], size=[64, 32], mode="bilinear", align_corners=True, align_mode=1
    )
...
def test_bilinear_interp_v2_5():
    ...
    test5.run(feed=[data], size=[128, 256], mode="bilinear", align_corners=False)
...
def test_bilinear_interp_v2_6():
    ...
    test6.run(feed=[data], size=[256, 512], mode="bilinear", align_corners=False)
...
def test_bilinear_interp_v2_7():
    ...
    test7.run(feed=[data], size=[512, 1024], mode="bilinear", align_corners=False)
