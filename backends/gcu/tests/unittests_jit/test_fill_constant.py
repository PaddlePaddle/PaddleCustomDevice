...
test = ApiBase(
    func=paddle.full, feed_names=[], feed_shapes=[], feed_dtypes=[], is_train=False
)
...
# test3 = ApiBase(func=paddle.base.layers.fill_constant_batch_size_like,
#                feed_names=['input'],
#                feed_shapes=[[2, 2]],
#                is_train=False)
...
# test4 = ApiBase(func=paddle.base.layers.fill_constant_batch_size_like,
#                feed_names=['input'],
#                feed_shapes=[[1, 2]],
#                is_train=False)
