...
test1 = ApiBase(
    func=paddle.nn.Hardsigmoid, feed_names=["data"], feed_shapes=[[1, 1, 640, 640]]
)
...
test2 = ApiBase(
    func=paddle.nn.Hardsigmoid, feed_names=["data"], feed_shapes=[[2, 1, 640, 640]]
)
...
test3 = ApiBase(
    func=paddle.nn.Hardsigmoid, feed_names=["data"], feed_shapes=[[2, 336, 1, 1]]
)
