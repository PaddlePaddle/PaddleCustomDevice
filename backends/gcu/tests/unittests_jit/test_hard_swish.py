...
test0 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[2, 4, 3, 640, 640]]
)
...
test1 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[1, 1, 640, 640]]
)
...
test2 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[2, 1, 640, 640]]
)
...
test3 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[2, 8, 352, 640]]
)
...
test4 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[2, 120, 44, 80]]
)
...
test5 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[16, 120, 88, 160]]
)
...
test6 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[16, 120, 44, 80]]
)
...
test7 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[16, 104, 44, 80]]
)
...
test8 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[16, 96, 44, 80]]
)
...
test9 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[16, 240, 44, 80]]
)
...
test10 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[16, 336, 44, 80]]
)
...
test11 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[16, 336, 22, 40]]
)
...
test12 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[16, 480, 22, 40]]
)
...
test13 = ApiBase(
    func=paddle.nn.Hardswish, feed_names=["data"], feed_shapes=[[16, 8, 352, 640]]
)
