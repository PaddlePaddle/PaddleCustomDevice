...
def test_meshgrid():
    with paddle.utils.unique_name.guard():
        with paddle.static.program_guard(
            ...
            data1 = paddle.static.data(name="data1", shape=[100], dtype="float32")
            data1.stop_gradient = True
            data2 = paddle.static.data(name="data2", shape=[200], dtype="float32")
            data2.stop_gradient = True
            data3 = paddle.static.data(name="data3", shape=[300], dtype="float32")
