...
def my_one_hot_v2(input, depth, allow_out_of_range=False):
    ...
    helper.append_op(
        type="one_hot_v2", inputs=inputs, attrs=attrs, outputs={"Out": one_hot_out}
    )
...
test_0 = ApiBase(
    func=my_one_hot_v2, feed_names=["data"], feed_shapes=[[4, 2]], feed_dtypes=["int64"]
)
...
test_1 = ApiBase(
    func=my_one_hot_v2, feed_names=["data"], feed_shapes=[[3]], feed_dtypes=["int64"]
)
...
test_2 = ApiBase(
    func=my_one_hot_v2, feed_names=["data"], feed_shapes=[[4]], feed_dtypes=["int64"]
)
...
test_3 = ApiBase(
    func=my_one_hot_v2, feed_names=["data"], feed_shapes=[[4, 1]], feed_dtypes=["int64"]
)
...
test_4 = ApiBase(
    func=my_one_hot_v2, feed_names=["data"], feed_shapes=[[3]], feed_dtypes=["int32"]
)
