...
# reduce_all = false
test1 = ApiBase(
    func=paddle.sum, feed_names=["data"], feed_shapes=[[1, 640, 640]], threshold=1.0e-3
)
...
# reduce_all = true
test2 = ApiBase(
    func=paddle.sum, feed_names=["data"], feed_shapes=[[1, 640, 640]], threshold=1.0e-2
)
...
test4 = ApiBase(func=paddle.sum, feed_names=["data"], feed_shapes=[[1, 704, 1280]])
