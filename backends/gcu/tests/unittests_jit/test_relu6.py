...
test0 = ApiBase(
    func=paddle.nn.functional.relu6,
    feed_names=["data"],
...
test1 = ApiBase(
    func=paddle.nn.functional.relu6, feed_names=["data"], feed_shapes=[[1, 1, 640, 640]]
)
...
test2 = ApiBase(
    func=paddle.nn.functional.relu6, feed_names=["data"], feed_shapes=[[2, 1, 640, 640]]
)
...
test3 = ApiBase(
    func=paddle.nn.functional.relu6, feed_names=["data"], feed_shapes=[[2, 8, 352, 640]]
)
...
test4 = ApiBase(
    func=paddle.nn.functional.relu6, feed_names=["data"], feed_shapes=[[2, 120, 44, 80]]
)
...
test8 = ApiBase(
    func=paddle.nn.functional.relu6, feed_names=["data"], feed_shapes=[[16, 96, 44, 80]]
)
