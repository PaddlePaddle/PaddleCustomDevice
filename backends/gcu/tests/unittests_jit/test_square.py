...
test9 = ApiBase(func=paddle.square, feed_names=["data"], feed_shapes=[[16, 10, 1, 1]])
...
test10 = ApiBase(func=paddle.square, feed_names=["data"], feed_shapes=[[16, 16, 1, 1]])
...
test11 = ApiBase(func=paddle.square, feed_names=["data"], feed_shapes=[[16, 60, 1, 1]])
...
test12 = ApiBase(func=paddle.square, feed_names=["data"], feed_shapes=[[16, 84, 1, 1]])
...
test13 = ApiBase(func=paddle.square, feed_names=["data"], feed_shapes=[[16, 120, 1, 1]])
