...
class TestReduceMaxOpMultiAxises(TestReduceMaxOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
...
class TestReduceAll(TestReduceMaxOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
...
class TestReduceMaxOpWithOutDtype_int32(TestReduceMaxOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
...
class TestReduceMaxOpWithOutDtype_int64(TestReduceMaxOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
...
class TestReduceMaxOpWithOutDtype_fp16(TestReduceMaxOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
...
class TestReduceMaxOpWithOutDtype_fp32(TestReduceMaxOp):
    """Remove Min with subgradient from gradient check to confirm the success of CI."""
