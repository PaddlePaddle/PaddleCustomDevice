...
PD_CUSTOM_KERNEL_REGISTER(add_raw,
                          iluvatar_gpu,
                          ALL_LAYOUT,
                          phi::AddRawKernel,
                          float,
...
PD_CUSTOM_KERNEL_REGISTER(divide_raw,
                          iluvatar_gpu,
                          ALL_LAYOUT,
                          phi::DivideRawKernel,
                          float,
...
PD_CUSTOM_KERNEL_REGISTER(multiply_raw,
                          iluvatar_gpu,
                          ALL_LAYOUT,
...
PD_CUSTOM_KERNEL_REGISTER(subtract_raw,
                          iluvatar_gpu,
                          ALL_LAYOUT,
...
PD_CUSTOM_KERNEL_REGISTER(maximum_raw,
                          iluvatar_gpu,
                          ALL_LAYOUT,
                          ...
                          float16,
                          bfloat16) {}
PD_CUSTOM_KERNEL_REGISTER(minimum_raw,
                          iluvatar_gpu,
                          ALL_LAYOUT,
                          ...
                          float16,
                          bfloat16) {}
PD_CUSTOM_KERNEL_REGISTER(remainder_raw,
                          iluvatar_gpu,
                          ALL_LAYOUT,
                          ...
                          int64_t,
                          bfloat16) {}
PD_CUSTOM_KERNEL_REGISTER(floor_divide_raw,
                          iluvatar_gpu,
                          ALL_LAYOUT,
                          ...
                          float16,
                          bfloat16) {}
PD_CUSTOM_KERNEL_REGISTER(elementwise_pow_raw,
                          iluvatar_gpu,
                          ALL_LAYOUT,
