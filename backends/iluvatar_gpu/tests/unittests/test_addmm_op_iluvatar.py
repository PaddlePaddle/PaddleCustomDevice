...
class TestAddMMOp(OpTest):
    ...
    def setUp(self):
        ...
        self.outputs = {
            "Out": self.inputs["Input"] + np.dot(self.inputs["X"], self.inputs["Y"])
        }
    ...
    def test_check_grad_normal(self):
        # TODO: support addmm_grad operator
        pass
        # self.check_grad(
        #     ['Input', 'X', 'Y'],
        #     'Out',
...
class TestAddMMOp3(OpTest):
    ...
    def test_check_grad_normal(self):
        self.check_grad(["Input", "X", "Y"], "Out", check_pir=True, check_prim_pir=True)
