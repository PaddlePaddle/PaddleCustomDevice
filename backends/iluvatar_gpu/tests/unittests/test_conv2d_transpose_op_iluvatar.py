...
class TestConv2DTransposeOp(OpTest):
    ...
    def test_check_output(self):
        ...
        if self.use_cudnn:
            ...
            self.check_output(check_dygraph=(not self.use_onednn), check_pir=True)
...
class TestFunctionalConv2DTranspose_ZeroSize2(TestFunctionalConv2DTranspose_ZeroSize):
    def init_data(self):
