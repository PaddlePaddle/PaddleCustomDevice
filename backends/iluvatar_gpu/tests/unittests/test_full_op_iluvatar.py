...
class TestFullAPI(unittest.TestCase):
    def test_api(self):
        ...
        with paddle.static.program_guard(paddle.static.Program()):
            ...
            out_9 = paddle.full(shape=10, dtype="complex64", fill_value=1.1 + 1.1j)

            out_10 = paddle.full(shape=10, dtype="complex64", fill_value=1.1 + 1.1j)
        ...
        np.testing.assert_array_equal(res_8, np.full([10], 1.1, dtype="float32"))
        np.testing.assert_allclose(res_9, np.full([10], 1.1 + 1.1j, dtype="complex64"))
        np.testing.assert_allclose(res_10, np.full([10], 1.1 + 1.1j, dtype="complex64"))
        np.testing.assert_allclose(res_9, np.full([10], 1.1 + 1.1j, dtype="complex64"))
        np.testing.assert_allclose(res_10, np.full([10], 1.1 + 1.1j, dtype="complex64"))
        ...
        np.testing.assert_allclose(
            res_12, np.full([10], 1.1 + np.inf * 1j, dtype="complex64")
        )
        np.testing.assert_allclose(
            res_13, np.full([10], 1.1 - np.inf * 1j, dtype="complex64")
        )
        np.testing.assert_allclose(
            res_14, np.full([10], 1.1 - np.inf * 1j, dtype="complex64")
        )
        np.testing.assert_allclose(
            res_15, np.full([10], 1.1 + np.nan * 1j, dtype="complex64")
        )
        np.testing.assert_allclose(
            res_16, np.full([10], 1.1 + np.nan * 1j, dtype="complex64")
        )
    ...
    def test_api_eager(self):
        with base.dygraph.base.guard():
            ...
            # test for numpy.float32 as fill_value
            ...
            np.testing.assert_array_equal(out_11, np.full([10], 1.1, dtype="float32"))
            np.testing.assert_allclose(
                out_12, np.full([1, 2, 3], 1.1 + 1.1j, dtype="complex64")
            )
            np.testing.assert_allclose(
                out_13, np.full([1, 2, 3], 1.1 + 1.1j, dtype="complex64")
            )
            np.testing.assert_allclose(
            ...
            np.testing.assert_allclose(
                out_15,
                np.full([1, 2, 3], 1.1 + np.inf * 1j, dtype="complex64"),
            )
            np.testing.assert_allclose(
            ...
            np.testing.assert_allclose(
                out_19,
                np.full([1, 2, 3], 1.1 + np.nan * 1j, dtype="complex64"),
            )
...
class TestFullOpError(unittest.TestCase):
    def test_errors(self):
        ...
        with paddle.static.program_guard(
            ...
            # float32, float32, uint8, int16, int32 or int64
            self.assertRaises(
