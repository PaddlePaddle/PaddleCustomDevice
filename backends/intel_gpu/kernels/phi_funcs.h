...
inline std::vector<int64_t> slice_ddim(const std::vector<int64_t>& dim,
                                       int begin,
                                       int end) {
...
template <typename T>
inline int64_t product(const std::vector<T>& ddim) {
...
inline int SizeToAxis(const int axis, std::vector<int64_t> dims) {
  int size = 1;
...
inline int SizeFromAxis(const int axis, std::vector<int64_t> dims) {
  int size = 1;
...
inline int SizeOutAxis(const int axis, std::vector<int64_t> dims) {
  int size = 1;
...
inline std::vector<int64_t> BroadcastDims(int axis,
