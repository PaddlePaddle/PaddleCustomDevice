...
add_custom_command(
  ...
  COMMAND ln -sf ${CU_BRIDGE_PATH}/bin/cucc ${CU_BRIDGE_PATH}/bin/nvcc
  DEPENDS ${CU_BRIDGE_PATH}/bin/cucc
  COMMENT "Link ${CU_BRIDGE_PATH}/bin/cucc to ${CU_BRIDGE_PATH}/bin/nvcc")

add_custom_target(WaitForSignalFile ALL DEPENDS ${CU_BRIDGE_PATH}/bin/nvcc)
...
ExternalProject_Add(
  ...
  CONFIGURE_COMMAND ""
  BUILD_COMMAND make -j8 CUDA_HOME=${CU_BRIDGE_PATH}
