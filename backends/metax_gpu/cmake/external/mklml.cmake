...
# Reserved. Copyright (c) 2017 PaddlePaddle Authors. All Rights Reserved.
#
...
if(WIN32)
  ...
  # TODO(intel-huying): Now enable csrmm function in mklml library temporarily,
...
function(download_mklml)
  ...
  # NOTE: If the version is updated, consider emptying the folder; maybe add
  # timeout
  file(
...
# Ninja Generator can not establish the correct dependency relationship between
# the imported library with target, the product file in the ExternalProject need
# to be specified manually, please refer to
