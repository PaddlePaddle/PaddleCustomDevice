...
# Create a target named "third_party", which can compile external dependencies
# on all platform(windows/linux/mac)
...
if(NOT WITH_SETUP_INSTALL)
  ...
  # execute_process does not support sequential commands, so we execute echo
  # command separately
  execute_process(
...
# parameters, URL / DIRNAME: 1. URL:           The download url of 3rd
# dependencies 2. NAME:          The name of file, that determine the dirname
#
...
if(WITH_ONNXRUNTIME)
  include(external/onnxruntime) # download, build, install
...
if(WITH_GPU)
  if(${CMAKE_CUDA_COMPILER_VERSION} LESS 11.0 AND NOT WITH_COREX)
