...
struct arg_default_impl<Scalar, true> {
  ...
  static inline RealScalar run(const Scalar& x)
  {
    // NOTE(xbei): there is NO arg() builtin function on MACA platform
...
#if EIGEN_GNUC_AT_LEAST(5,0) || defined(EIGEN_MACACC) // NOTE(xbei): 'noinline' and 'inline' are not compatible
