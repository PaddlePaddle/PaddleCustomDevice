...
#ifndef EIGEN_COMPLEX_MACA_H
#define EIGEN_COMPLEX_MACA_H
...
// operators and functors for complex types when building for MACA to enable
// their use on-device.
//
// NOTES:
...
#if defined(EIGEN_MACACC) && defined(EIGEN_GPU_COMPILE_PHASE)
...
#endif  // EIGEN_MACACC && EIGEN_GPU_COMPILE_PHASE

#endif  // EIGEN_COMPLEX_MACA_H
