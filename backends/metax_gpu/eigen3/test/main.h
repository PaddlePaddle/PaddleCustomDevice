...
// compiler error.
// TODO(xbei): check whether maca has the same problem as hip platform
#if !defined(__HIPCC__) && !defined(__MACACC__) && !defined(EIGEN_USE_SYCL)
  //
...
#if !defined(__MACA__) // NOTE(xbei): there is a definition of M_PI in mc_runtime.h
#ifdef M_PI
#undef M_PI
#endif
...
#define EIGEN_DEFAULT_IO_FORMAT IOFormat(4, 0, "  ", "\n", "", "", "", "")
  ...
  #elif !defined(__CUDACC__) && !defined(__HIPCC__) && !defined(__MACACC__) && !defined(SYCL_DEVICE_ONLY) // EIGEN_DEBUG_ASSERTS
...
int main(int argc, char *argv[])
{
    ...
    g_seed = 0;   // NOTE(xbei): set g_seed to 0 to make acl test stable
