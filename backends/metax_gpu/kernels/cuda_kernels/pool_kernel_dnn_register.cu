...
//   T* transformed_output_data = dev_ctx.template
//   Alloc<T>(&transformed_output);
...
//   PADDLE_ENFORCE_GPU_SUCCESS(hipMalloc(&pool_workspace,
//   pool_workernel_size_)); PADDLE_ENFORCE_GPU_SUCCESS(
...
// template <typename T, typename Context>
// void Pool2dGPUDNNKernel_(const Context& dev_ctx,
//                         const DenseTensor& x,
...
// template <typename T, typename Context>
// void Pool3dGPUDNNKernel_(const Context& dev_ctx,
//                         const DenseTensor& x,
//                         const std::vector<int64_t>& kernel_size,
//                         const std::vector<int64_t>& strides,
//                         const std::vector<int64_t>& paddings,
