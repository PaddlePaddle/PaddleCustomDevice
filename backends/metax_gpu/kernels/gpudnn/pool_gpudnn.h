...
class CudnnIndexType<int> {
 public:
  ...
  static const mcdnnDataType_t type = CUDNN_DATA_INT32;
#else
  static const mcdnnDataType_t type = miopenInt32;
#endif
};
...
class CudnnIndexType<int8_t> {
 public:
#ifdef PADDLE_WITH_CUDA
  static const mcdnnDataType_t type = CUDNN_DATA_INT8;
#else
  static const mcdnnDataType_t type = miopenInt8;
#endif
};
