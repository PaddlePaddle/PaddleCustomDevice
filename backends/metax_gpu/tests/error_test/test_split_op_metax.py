...
class TestSplitOpErrorStatic(unittest.TestCase):
    def test_errors_with_static(self):
        ...
        with paddle.static.program_guard(
            ...
            def test_axis_type():
                x5 = paddle.static.data(shape=[-1, 4], dtype="float16", name="x5")
            ...
            def test_axis_type_tensor():
                x8 = paddle.static.data(shape=[-1, 4], dtype="float16", name="x8")
...
class API_TestDygraphFluidSplit(unittest.TestCase):
    def test_out1(self):
        with base.dygraph.guard():
            ...
            manual_grad[:, :2, :] = 1
            np.testing.assert_allclose(input.gradient(), manual_grad, rtol=1e-05)
