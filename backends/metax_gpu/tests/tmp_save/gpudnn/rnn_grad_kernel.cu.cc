...
//     temp.ShareDataWith(tensor.Slice(weight_offset, weight_offset +
//     numel_size));
...
//           place,
//           stream,
//           {split_tensor[0], split_tensor[1], split_tensor[3],
//           split_tensor[2]},
//           (*weight_grad_list)[i]);
...
//         place, stream, &weight_list_tmp, &weight_whole, rnn_mode,
//         is_bidirec);
// #else
...
//           place, stream, weight_grad, &weight_grad_list, rnn_mode,
//           is_bidirec);
// #else
