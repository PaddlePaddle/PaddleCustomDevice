...
class TestScatterBF16Op(TestScatterOp):
    ...
    def test_check_output(self):
        place = core.CustomPlace("metax_gpu", 0)
...
class TestScatterNegativeAxis(OpTest):
    ...
    def test_check_output(self):
        ...
        places.append(paddle.CustomPlace("metax_gpu", 0))
        for place in places:
...
class TestScatterAPI(unittest.TestCase):
    def setUp(self):
        self.places = [paddle.CustomPlace("metax_gpu", 0)]
        self.executed_api()
        ...
        def test_static_graph():
            with paddle.static.program_guard(
                ...
                with paddle.static.scope_guard(scope):
                    ...
                    fetch = [out_t]
                    gpu_exe = paddle.static.Executor(paddle.CustomPlace("metax_gpu", 0))
