...
class TestAdamWOpLayerwiseLR(TestAdamWOp):
        ...
        with paddle.pir_utils.OldIrGuard():
            ...
            with paddle.static.program_guard(train_prog, startup):
                with base.unique_name.guard():
                    ...
                    fc1_w_mon2_max = np.zeros(linear1.weight.shape).astype("float32")
                    ...
                    fc2_w_mon2_max = np.zeros(linear2.weight.shape).astype("float32")
    ...
    def test_adamw_op_with_pir(self):
        with paddle.pir_utils.IrGuard():
            ...
            train_fetch_list = [item for sublist in params_grads for item in sublist]
