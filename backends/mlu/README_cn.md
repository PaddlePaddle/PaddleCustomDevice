...
docker pull registry.baidubce.com/device/paddle-mlu:cntoolkit3.10.2-1-cnnl1.25.1-1-gcc82
...
docker run -it --name paddle-mlu-dev -v `pwd`:/workspace \
    ...
    registry.baidubce.com/device/paddle-mlu:cntoolkit3.10.2-1-cnnl1.25.1-1-gcc82 /bin/bash
...
# 预期得到如下输出结果
version: 2.6.0
commit: 289def146fa68fcac908a27dab8a5afd1be100be
cntoolkit: 3.10.2
cnnl: 1.25.1
cnnlextra: 1.8.1
cncl: 1.16.0
