...
/* static */ void MLUCnnl::L2Loss(const Context& ctx,
  ...
  cnnlHandle_t handle = GetHandleFromCTX(ctx);
  size_t workspace_size;
  PADDLE_ENFORCE_MLU_SUCCESS(cnnlGetL2LossWorkspaceSize(handle, input_desc, &workspace_size));
  ...
  PADDLE_ENFORCE_MLU_SUCCESS(cnnlL2Loss_v2(handle, input_desc, input, workspace_ptr,
...
/* static */ void MLUCnnl::LayerNormBackward(
  ...
  cnnlHandle_t handle = GetHandleFromCTX(ctx);
  size_t workspace_size;
  PADDLE_ENFORCE_MLU_SUCCESS(cnnlGetLayerNormBackwardWorkspaceSize(handle,
                                                                   x_desc,
                                                                   axis,
                                                                   &workspace_size));
...
/* static */ void MLUCnnl::SyncBatchNormStats(
  ...
  cnnlHandle_t handle = GetHandleFromCTX(ctx);
  size_t workspace_size;
  PADDLE_ENFORCE_MLU_SUCCESS(cnnlGetSyncBatchNormStatsWorkspaceSize(handle, x_desc,
      &workspace_size));
...
/* static */ void MLUCnnl::SyncBatchnormBackwardReduce(
  ...
  size_t workspace_size;
  PADDLE_ENFORCE_MLU_SUCCESS(
      cnnlGetSyncBatchnormBackwardReduceWorkspaceSize(handle,
                                                      desc_x,
                                                      &workspace_size));
