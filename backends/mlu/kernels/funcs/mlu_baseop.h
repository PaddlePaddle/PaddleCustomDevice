...
inline cnnlDataType_t ToCnnlDataType(const DataType& dtype) {
...
const std::map<std::pair<DataType, DataType>, cnnlCastDataType_t>
    MLU_SUPPORTED_CAST_TYPE = {
        {{DataType::FLOAT32, /*cast to*/ DataType::FLOAT16},
         CNNL_CAST_FLOAT_TO_HALF},
        {{DataType::FLOAT32, /*cast to*/ DataType::INT32},
         CNNL_CAST_FLOAT_TO_INT32},
        {{DataType::FLOAT32, /*cast to*/ DataType::INT16},
         CNNL_CAST_FLOAT_TO_INT16},
        {{DataType::FLOAT32, /*cast to*/ DataType::INT8},
         CNNL_CAST_FLOAT_TO_INT8},
        {{DataType::FLOAT32, /*cast to*/ DataType::UINT8},
         CNNL_CAST_FLOAT_TO_UINT8},
        {{DataType::FLOAT32, /*cast to*/ DataType::BOOL},
         CNNL_CAST_FLOAT_TO_BOOL},
        {{DataType::FLOAT16, /*cast to*/ DataType::FLOAT32},
         CNNL_CAST_HALF_TO_FLOAT},
        {{DataType::FLOAT16, /*cast to*/ DataType::INT32},
         CNNL_CAST_HALF_TO_INT32},
        {{DataType::FLOAT16, /*cast to*/ DataType::INT16},
         CNNL_CAST_HALF_TO_INT16},
        {{DataType::FLOAT16, /*cast to*/ DataType::INT8},
         CNNL_CAST_HALF_TO_INT8},
        {{DataType::FLOAT16, /*cast to*/ DataType::UINT8},
         CNNL_CAST_HALF_TO_UINT8},
        {{DataType::FLOAT16, /*cast to*/ DataType::BOOL},
         CNNL_CAST_HALF_TO_BOOL},
        {{DataType::INT32, /*cast to*/ DataType::FLOAT32},
         CNNL_CAST_INT32_TO_FLOAT},
        {{DataType::INT32, /*cast to*/ DataType::FLOAT16},
         CNNL_CAST_INT32_TO_HALF},
        {{DataType::INT32, /*cast to*/ DataType::INT8},
         CNNL_CAST_INT32_TO_INT8},
        {{DataType::INT32, /*cast to*/ DataType::INT16},
         CNNL_CAST_INT32_TO_INT16},
        {{DataType::INT16, /*cast to*/ DataType::FLOAT32},
         CNNL_CAST_INT16_TO_FLOAT},
        {{DataType::INT16, /*cast to*/ DataType::FLOAT16},
         CNNL_CAST_INT16_TO_HALF},
        {{DataType::INT16, /*cast to*/ DataType::INT32},
         CNNL_CAST_INT16_TO_INT32},
        {{DataType::INT8, /*cast to*/ DataType::FLOAT32},
         CNNL_CAST_INT8_TO_FLOAT},
        {{DataType::INT8, /*cast to*/ DataType::FLOAT16},
         CNNL_CAST_INT8_TO_HALF},
        {{DataType::INT8, /*cast to*/ DataType::INT32},
         CNNL_CAST_INT8_TO_INT32},
        {{DataType::UINT8, /*cast to*/ DataType::FLOAT32},
         CNNL_CAST_UINT8_TO_FLOAT},
        {{DataType::UINT8, /*cast to*/ DataType::FLOAT16},
         CNNL_CAST_UINT8_TO_HALF},
        {{DataType::BOOL, /*cast to*/ DataType::FLOAT32},
         CNNL_CAST_BOOL_TO_FLOAT},
        {{DataType::BOOL, /*cast to*/ DataType::FLOAT16},
         CNNL_CAST_BOOL_TO_HALF},
        {{DataType::BOOL, /*cast to*/ DataType::INT32},
         CNNL_CAST_BOOL_TO_INT32},
        {{DataType::UINT8, /*cast to*/ DataType::INT32},
         CNNL_CAST_UINT8_TO_INT32},
        {{DataType::INT32, /*cast to*/ DataType::INT64},
         CNNL_CAST_INT32_TO_INT64},
        {{DataType::INT64, /*cast to*/ DataType::INT32},
         CNNL_CAST_INT64_TO_INT32},
        {{DataType::INT32, /*cast to*/ DataType::BOOL},
         CNNL_CAST_INT32_TO_BOOL},
        {{DataType::UINT8, /*cast to*/ DataType::INT64},
         CNNL_CAST_UINT8_TO_INT64},
        {{DataType::INT8, /*cast to*/ DataType::INT16},
         CNNL_CAST_INT8_TO_INT16},
        {{DataType::FLOAT32, /*cast to*/ DataType::FLOAT64},
         CNNL_CAST_FLOAT_TO_DOUBLE},
        {{DataType::FLOAT64, /*cast to*/ DataType::FLOAT32},
         CNNL_CAST_DOUBLE_TO_FLOAT},
        {{DataType::INT64, /*cast to*/ DataType::FLOAT32},
         CNNL_CAST_INT64_TO_FLOAT},
        {{DataType::INT64, /*cast to*/ DataType::FLOAT16},
         CNNL_CAST_INT64_TO_HALF},
        {{DataType::FLOAT32, /*cast to*/ DataType::INT64},
         CNNL_CAST_FLOAT_TO_INT64},
        {{DataType::FLOAT16, /*cast to*/ DataType::INT64},
...
bool MLUSupportsCast(const DataType& src_type, const DataType& dst_type);
...
class MLUCnnlRandomGeneratorDesc {
 public:
  MLUCnnlRandomGeneratorDesc(const Context& ctx, const int seed);
...
const std::shared_ptr<MLUCnnlRandomGeneratorDesc>& GetMLURandomGenerator(
    const Context& ctx, const int64_t device_id, const int seed);
...
class MLUCnnlBatchSpaceDesc {
 public:
  ...
  void getBatch2spaceNdextraInputSize(const Context& ctx,
                                      const cnnlTensorDescriptor_t input_desc);

  void getSpace2batchNdextraInputSize(const Context& ctx,
                                      const cnnlTensorDescriptor_t input_desc);

  void initSpace2batchNdExtraInput(const Context& ctx,
                                   const cnnlTensorDescriptor_t input_desc,
                                   void* extra_host_input);

  void initBatch2spaceNdExtraInput(const Context& ctx,
                                   const cnnlTensorDescriptor_t input_desc,
                                   void* extra_host_input);
...
class MLUCnnl {
 public:
  ...
  static void ActiveGrad(const Context& ctx,
                         cnnlActivationDescriptor_t active_desc,
                         const void* alpha,
                         const void* beta,
  ...
  static void Concat(const Context& ctx,
                     const int pack_num,
                     const int axis,
                     ...
                     const cnnlTensorDescriptor_t output_desc,
                     void* output);
  static void CTCLoss(const Context& ctx,
  ...
  static void Cast(const Context& ctx,
  ...
  static void Clip(const Context& ctx,
                   const cnnlTensorDescriptor_t input_desc,
                   const void* input,
                   const void* min,
                   const void* max,
  ...
  static void Div(const Context& ctx,
  ...
  static void QuantifyOffline(const Context& context,
  ...
  static void QuantifyOnline(const Context& context,
                             const int bitwidth,
                             const cnnlTensorDescriptor_t input_desc,
                             const void* input,
  ...
  static void SGD(const Context& context,
  ...
  static void ApplyAdaGrad(const Context& ctx,
                           const cnnlTensorDescriptor_t grad_desc,
                           const void* grad,
  ...
  static void ApplyRMSProp(const Context& context,
                           const cnnlTensorDescriptor_t grad_desc,
                           const void* grad,
                           const void* lr,
                           const void* rho,
  ...
  static void ApplyCenterRMSProp(const Context& ctx,
                                 const cnnlTensorDescriptor_t grad_desc,
                                 const void* grad,
                                 const void* lr,
                                 const void* rho,
  ...
  static void ApplyAdam(const Context& ctx,
                        const cnnlTensorDescriptor_t var_desc,
                        void* var,
  ...
  static void ApplyAdaMax(const Context& ctx,
                          const cnnlTensorDescriptor_t grad_desc,
                          const cnnlTensorDescriptor_t var_desc,
                          void* var,
                          const cnnlTensorDescriptor_t m_desc,
  ...
  static void ApplyMomentum(const Context& ctx,
                            const cnnlTensorDescriptor_t grad_desc,
                            const void* grad,
                            const bool use_nesterov,
                            const void* lr,
  ...
  static void ApplyKerasMomentum(const Context& ctx,
                                 const cnnlTensorDescriptor_t grad_desc,
                                 const void* grad,
                                 const bool use_nesterov,
                                 const void* lr,
  ...
  static void ApplyAdadelta(const Context& ctx,
                            const cnnlTensorDescriptor_t grad_desc,
                            const void* diff,
                            const void* lr,
                            const void* rho,
  ...
  static void RandomUniform(const Context& ctx,
                            const int num,
                            const cnnlDataType_t data_type,
  ...
  static void FusedDropout(const Context& ctx,
  ...
  static void Cumsum(const Context& ctx,
                     const int axis,
  ...
  static void BroadcastTo(const Context& ctx,
                          const cnnlTensorDescriptor_t input_desc,
                          const void* input,
                          const cnnlTensorDescriptor_t output_desc,
                          void* output);

  static void GatherFunctor(const Context& ctx,
                            const int axis,
  ...
  static void ScatterRefFunctor(const Context& ctx,
                                const cnnlTensorDescriptor_t params_desc,
                                const void* params,
  ...
  static void ScatterFunctor(const Context& ctx,
                             const cnnlTensorDescriptor_t params_desc,
                             void* params,
                             const cnnlTensorDescriptor_t updates_desc,
                             const void* updates,
  ...
  static void Range(const Context& ctx,
                    const void* start,
                    const void* end,
                    const void* step,
  ...
  static void TopK(const Context& ctx,
                   const int k,
                   const int dim,
                   const bool largest,
                   const bool sorted,
  ...
  static void Split(const Context& ctx,
                    int split_num,
                    int axis,
                    const cnnlTensorDescriptor_t input_desc,
  ...
  static void Scale(const Context& ctx,
                    const int axis,
                    const cnnlTensorDescriptor_t input_desc,
                    const void* input,
  ...
  static void AddN(const Context& ctx,
                   uint32_t input_num,
                   const cnnlTensorDescriptor_t inputs_desc[],
                   const void* inputs[],
                   const cnnlTensorDescriptor_t output_desc,
  ...
  static void StridedSliceGrad(const Context& ctx,
                               const int begin[],
                               const int end[],
                               const int strides[],
                               const cnnlTensorDescriptor_t input_desc,
  ...
  static void Logic(const Context& ctx,
  ...
  static void Select(const Context& ctx,
  ...
  static void AssignAdd(const Context& ctx,
                        const void* alpha,
                        const void* beta,
  ...
  static void AssignSub(const Context& ctx,
                        const void* alpha,
                        const void* beta,
                        const cnnlTensorDescriptor_t update_desc,
                        const void* update,
  ...
  static void Assign(const Context& ctx,
                     const cnnlTensorDescriptor_t update_desc,
                     const void* update,
                     const cnnlTensorDescriptor_t param_desc,
                     void* param);

  static void GatherNd(const Context& ctx,
                       const cnnlTensorDescriptor_t params_desc,
                       const void* params,
                       const cnnlTensorDescriptor_t indices_desc,
                       const void* indices,
  ...
  static void BatchToSpace(const Context& ctx,
                           const cnnlTensorDescriptor_t input_desc,
                           const void* input,
                           const cnnlTensorDescriptor_t output_desc,
                           void* output,
  ...
  static void BatchToSpaceNd(const Context& ctx,
                             const cnnlTensorDescriptor_t input_desc,
                             const void* input,
  ...
  static void PoolingForward(const Context& ctx,
  ...
  static void AdaptivePoolingForward(const Context& ctx,
                                     cnnlPoolingMode_t pool_mode,
                                     const cnnlTensorDescriptor_t input_desc,
                                     const void* input,
                                     const cnnlTensorDescriptor_t output_desc,
  ...
  static void Pool3D(const Context& ctx,
                     cnnlPoolingMode_t pool_mode,
  ...
  static void Pad(const Context& ctx,
                  const cnnlTensorDescriptor_t input_desc,
                  const void* input,
                  const void* paddings,
  ...
  static void Matmul(const Context& ctx,
  ...
  static void MulAx(const Context& ctx,
                    const cnnlTensorDescriptor_t alpha_desc,
                    const void* alpha,
                    const cnnlTensorDescriptor_t output_desc,
                    void* output);

  static void OpTensor(const Context& ctx,
  ...
  static void BiasAddGrad(const Context& ctx,
                          const int axis,
  ...
  static void OneHot(const Context& ctx,
  ...
  static void NonMaxSuppression(const Context& ctx,
  ...
  static void SoftmaxForward(const Context& ctx,
  ...
  static void SoftmaxBackward(const Context& ctx,
                              cnnlSoftmaxAlgorithm_t algorithm,
                              cnnlSoftmaxMode_t mode,
                              const cnnlTensorDescriptor_t y_desc,
                              const void* y,
  ...
  static void Softplus(const Context& ctx,
                       const cnnlTensorDescriptor_t features_desc,
                       const void* features,
                       const cnnlTensorDescriptor_t output_desc,
                       void* output);

  static void SoftplusGrad(const Context& ctx,
  ...
  static void RsqrtGrad(const Context& ctx,
                        const cnnlTensorDescriptor_t data_desc,
                        const void* y,
                        const void* diff_y,
                        void* output);

  static void SqrtGrad(const Context& ctx,
                       const cnnlTensorDescriptor_t data_desc,
                       const void* y,
                       const void* diff_y,
                       void* output);

  static void ConvolutionForward(const Context& ctx,
  ...
  static void FusedConvBNQuantify(const Context& ctx,
  ...
  static void Tile(const Context& ctx,
                   const cnnlTensorDescriptor_t input_desc,
                   const void* input,
                   const cnnlTensorDescriptor_t output_desc,
                   void* output);

  static void UnsortedSegmentSum(const Context& ctx,
                                 const cnnlTensorDescriptor_t data_desc,
                                 const void* data,
  ...
  static void Reduce(const Context& ctx,
  ...
  static void FloorMod(const Context& ctx,
                       const cnnlTensorDescriptor_t input1_desc,
                       const void* input1,
                       const cnnlTensorDescriptor_t input2_desc,
                       const void* input2,
  ...
  static void Maximum(const Context& ctx,
                      const cnnlTensorDescriptor_t input1_desc,
                      const void* input1,
                      const cnnlTensorDescriptor_t input2_desc,
                      const void* input2,
  ...
  static void Minimum(const Context& ctx,
                      const cnnlTensorDescriptor_t input1_desc,
                      const void* input1,
                      const cnnlTensorDescriptor_t input2_desc,
                      const void* input2,
  ...
  static void Pow(const Context& ctx,
                  cnnlComputationPreference_t prefer,
                  const cnnlTensorDescriptor_t input1_desc,
                  const void* input1,
                  const cnnlTensorDescriptor_t input2_desc,
  ...
  static void PowR(const Context& ctx,
                   cnnlComputationPreference_t prefer,
                   const cnnlTensorDescriptor_t input1_desc,
                   const void* input1,
                   const cnnlTensorDescriptor_t input2_desc,
  ...
  static void DivNoNan(const Context& ctx,
                       cnnlComputationPreference_t prefer,
                       const cnnlTensorDescriptor_t input1_desc,
                       const void* input1,
                       const cnnlTensorDescriptor_t input2_desc,
  ...
  static void SquaredDifference(const Context& ctx,
                                const cnnlTensorDescriptor_t input1_desc,
                                const void* input1,
                                const cnnlTensorDescriptor_t input2_desc,
                                const void* input2,
  ...
  static void L2Loss(const Context& ctx,
                     const cnnlTensorDescriptor_t input_desc,
                     const void* input,
                     void* output);

  static void Abs(const Context& ctx,
                  const cnnlTensorDescriptor_t input_desc,
                  const void* input,
                  const cnnlTensorDescriptor_t output_desc,
                  void* output);
  ...
  static void Floor(const Context& ctx,
                    const cnnlTensorDescriptor_t input_desc,
                    const void* input,
                    const cnnlTensorDescriptor_t output_desc,
                    void* output);

  static void Ceil(const Context& ctx,
                   const cnnlTensorDescriptor_t input_desc,
                   const void* input,
                   const cnnlTensorDescriptor_t output_desc,
                   void* output);

  static void IsNan(const Context& ctx,
                    const cnnlTensorDescriptor_t input_desc,
                    const void* input,
                    const cnnlTensorDescriptor_t output_desc,
                    void* output);

  static void Square(const Context& ctx,
                     const cnnlTensorDescriptor_t input_desc,
                     const void* input,
                     const cnnlTensorDescriptor_t output_desc,
                     void* output);

  static void Sqrt(const Context& ctx,
                   cnnlComputationPreference_t prefer,
                   const cnnlTensorDescriptor_t input_desc,
                   const void* input,
                   const cnnlTensorDescriptor_t output_desc,
  ...
  static void Rsqrt(const Context& ctx,
                    cnnlComputationPreference_t prefer,
                    const cnnlTensorDescriptor_t input_desc,
                    const void* input,
                    const cnnlTensorDescriptor_t output_desc,
  ...
  static void Cos(const Context& ctx,
                  cnnlComputationPreference_t prefer,
                  const cnnlTensorDescriptor_t input_desc,
                  const void* input,
                  const cnnlTensorDescriptor_t output_desc,
  ...
  static void Sin(const Context& ctx,
                  cnnlComputationPreference_t prefer,
                  const cnnlTensorDescriptor_t input_desc,
                  const void* input,
                  const cnnlTensorDescriptor_t output_desc,
  ...
  static void TrigonForward(const Context& ctx,
  ...
  static void Exp(const Context& ctx,
                  cnnlComputationPreference_t prefer,
                  const cnnlTensorDescriptor_t input_desc,
                  const void* input,
                  const cnnlTensorDescriptor_t output_desc,
  ...
  static void Sign(const Context& ctx,
                   const cnnlTensorDescriptor_t input_desc,
                   const void* input,
                   const cnnlTensorDescriptor_t output_desc,
                   void* output);

  static void IndexSelect(const Context& ctx,
                          const int dim,
  ...
  static void IsFinite(const Context& ctx,
                       const cnnlTensorDescriptor_t input_desc,
                       const void* input,
                       const cnnlTensorDescriptor_t output_desc,
                       void* output);

  static void IsNanInf(const Context& ctx,
                       const cnnlTensorDescriptor_t input_desc,
                       const void* input,
                       void* output);

  static void Erf(const Context& ctx,
                  cnnlComputationPreference_t prefer,
                  const cnnlTensorDescriptor_t input_desc,
                  const void* input,
                  const cnnlTensorDescriptor_t output_desc,
  ...
  static void Log1p(const Context& ctx,
                    cnnlComputationPreference_t prefer,
                    const cnnlTensorDescriptor_t input_desc,
                    const void* input,
                    const cnnlTensorDescriptor_t output_desc,
  ...
  static void PoolingBackward(const Context& ctx,
  ...
  static void AdaptivePoolingBackward(const Context& ctx,
  ...
  static void PoolingIndex(const Context& ctx,
                           const cnnlPoolingDescriptor_t pooling_desc,
                           const cnnlTensorDescriptor_t x_desc,
                           const void* x,
                           const cnnlTensorDescriptor_t y_desc,
  ...
  static void SpaceToBatch(const Context& ctx,
                           const cnnlTensorDescriptor_t input_desc,
                           const void* input,
                           const cnnlTensorDescriptor_t output_desc,
                           void* output,
  ...
  static void SpaceToBatchNd(const Context& ctx,
                             const cnnlTensorDescriptor_t input_desc,
                             const void* input,
                             cnnlSpaceBatchNdDescriptor_t param,
                             void* extra_device_input,
  ...
  static void Interp(const Context& ctx,
  ...
  static void QuantizeParam(const Context& ctx,
  ...
  static void QuantizeMatMul(const Context& ctx,
                             const bool transpose_a,
                             const bool transpose_b,
                             const cnnlTensorDescriptor_t a_desc,
                             const void* a,
  ...
  static void QuantizeBatchMatMul(const Context& ctx,
                                  const bool adj_x,
                                  const bool adj_y,
                                  const cnnlTensorDescriptor_t a_desc,
                                  const void* a,
  ...
  static void QuantizeBatchMatMulBCast(const Context& ctx,
                                       const bool adj_x,
                                       const bool adj_y,
                                       const cnnlTensorDescriptor_t a_desc,
                                       const void* a,
  ...
  static void LayerNormBackward(const Context& ctx,
                                int axis,
                                const cnnlTensorDescriptor_t x_desc,
                                const void* x,
  ...
  static void TrilTriu(const Context& ctx,
  ...
  static void MatrixBandPart(const Context& ctx,
                             const cnnlTensorDescriptor_t data_desc,
                             const void* input,
                             const int num_lower,
                             const int num_upper,
  ...
  static void NumTrue(const Context& ctx,
                      const cnnlTensorDescriptor_t x_desc,
                      const void* x,
                      const cnnlTensorDescriptor_t num_true_desc,
                      void* num_true);

  static void Where(const Context& ctx,
                    const cnnlTensorDescriptor_t x_desc,
                    const void* x,
                    const cnnlTensorDescriptor_t num_true_desc,
                    const void* num_true,
                    ...
                    const cnnlTensorDescriptor_t y_desc,
                    void* y);
  static void Conv2D(const Context& ctx,
  ...
  static void ConvBackpropInput(const Context& ctx,
                                const cnnlConvolutionDescriptor_t conv_desc,
                                const cnnlTensorDescriptor_t filter_desc,
                                const void* filter,
                                const cnnlTensorDescriptor_t out_backprop_desc,
  ...
  static void DCNForward(const Context& ctx,
  ...
  static void DCNBackwardData(const Context& ctx,
                              const cnnlDCNDescriptor_t dcn_desc,
                              const cnnlTensorDescriptor_t input_desc,
                              const void* input,
                              const cnnlTensorDescriptor_t offset_desc,
  ...
  static void DCNBackwardWeight(const Context& ctx,
                                const cnnlDCNDescriptor_t dcn_desc,
                                const cnnlTensorDescriptor_t input_desc,
                                const void* input,
                                const cnnlTensorDescriptor_t offset_desc,
  ...
  static void InTopK(const Context& ctx,
  ...
  static void ScatterNd(const Context& ctx,
  ...
  static void BitWise(const Context& ctx,
  ...
  static void QR(const Context& ctx,
                 const cnnlTensorDescriptor_t a_desc,
                 const void* a,
  ...
  static void Reciprocal(const Context& ctx,
                         const cnnlTensorDescriptor_t input_desc,
                         const void* input,
                         const cnnlTensorDescriptor_t output_desc,
                         void* output);

  static void BceLoss(const Context& ctx,
  ...
  static void BceLossBackward(const Context& ctx,
                              const cnnlBceLossReduction_t reduction,
                              const cnnlTensorDescriptor_t grad_desc,
                              const void* grad,
                              const cnnlTensorDescriptor_t input_desc,
  ...
  static void RNNForward(const Context& ctx,
  ...
  static void RNNBackward(const Context& ctx,
                          const cnnlRNNDescriptor_t rnn_desc,
  ...
  static void Mask(const Context& ctx,
  ...
  static void EmbeddingBackward(const Context& ctx,
                                int padding_idx,
  ...
  static void BceWithLogits(const Context& ctx,
  ...
  static void RoiAlign(const Context& ctx,
  ...
  static void RoiAlignBackward(const Context& ctx,
                               const int sampling_ratio,
                               const float spatial_scale,
                               const bool aligned,
                               const cnnlTensorDescriptor_t grads_desc,
  ...
  static void SyncBatchNormElemt(const Context& ctx,
                                 const cnnlTensorDescriptor_t x_desc,
                                 const void* x,
                                 const cnnlTensorDescriptor_t mean_desc,
                                 const void* mean,
...
inline void SetMLUTransposePerm(const phi::DDim& dims,
...
template <typename T>
inline void TransposeFromMLUTensor(const Context& ctx,
                                   const std::vector<int> perm,
  ...
  if (need_reshape_or_alloc) {
    ...
    transformed_output->Resize(phi::DDim(output_shape.data(), dim_size));
    ctx.template Alloc<T>(transformed_output);
  }
...
template <typename T>
inline void FillMLUTensorWithHostValue(const Context& ctx,
                                       T value,
                                       Tensor* out) {
