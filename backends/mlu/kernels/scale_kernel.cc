...
void ScaleKernel(const Context& dev_ctx,
    ...
    if (std::isinf(scale)) {
        ...
        phi::DenseTensorMeta scale_meta = {x.dtype(), {1}, phi::DataLayout::kNHWC};
        scale_tensor.set_meta(scale_meta);
    ...
    phi::DenseTensorMeta bias_meta = {x.dtype(), {1}, phi::DataLayout::kNHWC};
    ...
    if (bias_after_scale) {
      ...
      phi::DenseTensorMeta new_bias_meta = {x.dtype(), {1}, phi::DataLayout::kNHWC};
      new_bias_tensor.set_meta(new_bias_meta);
