...
class TestMultinomialOp(OpTest):
    ...
    def init_data(self):
        ...
        self.input_np = np.random.rand(4).astype("float32")
...
class TestMultinomialOp2(TestMultinomialOp):
    def init_data(self):
        ...
        self.input_np = np.random.rand(3, 4).astype("float32")
...
class TestMultinomialOp3(TestMultinomialOp):
    def init_data(self):
        ...
        self.input_np = np.random.rand(1000).astype("float32")
...
class TestMultinomialApi(unittest.TestCase):
    def test_dygraph(self):
        ...
        x_numpy = np.random.rand(4).astype("float32")
    ...
    def test_dygraph2(self):
        ...
        paddle.set_device("mlu:0")
        paddle.disable_static()
        x_numpy = np.random.rand(3, 4).astype("float32")
        x = paddle.to_tensor(x_numpy)
        out = paddle.multinomial(x, num_samples=100000, replacement=True)
    ...
    def test_dygraph3(self):
        ...
        paddle.set_device("mlu:0")
        paddle.disable_static()
        x_numpy = np.random.rand(1000).astype("float32")
        x = paddle.to_tensor(x_numpy)
...
class TestMultinomialError(unittest.TestCase):
    ...
    def test_input_probs_dim(self):
        ...
        def test_dim_less_than_1():
            x_np = np.random.random([]).astype("float32")
