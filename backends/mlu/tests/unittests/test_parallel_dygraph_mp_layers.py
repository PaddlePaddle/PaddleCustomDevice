...
class TestColumnModelParallelLayer(TestMultipleCustomDevices):
    def test_hybrid_parallel_mp_layer(self):
        self.run_mnist_2_custom_devices(
            "model_parallel/hybrid_column_parallel_mp_layers.py", "mlu"
        )


class TestCrossEntropyModelParallelLayer(TestMultipleCustomDevices):
    def test_hybrid_parallel_mp_layer(self):
        self.run_mnist_2_custom_devices(
            "model_parallel/hybrid_cross_entropy_parallel_mp_layers.py", "mlu"
        )


class TestEmbeddingModelParallelLayer(TestMultipleCustomDevices):
    def test_hybrid_parallel_mp_layer(self):
        self.run_mnist_2_custom_devices(
            "model_parallel/hybrid_embedding_parallel_mp_layers.py", "mlu"
        )


class TestRowModelParallelLayer(TestMultipleCustomDevices):
    def test_hybrid_parallel_mp_layer(self):
        self.run_mnist_2_custom_devices(
            "model_parallel/hybrid_row_parallel_mp_layers.py", "mlu"
        )
