...
class TestMLUROPEFP32(unittest.TestCase):
    def setUp(self):
    ...
    def check_result(self, golden_res, fused_res):
        if self.dtype == "float32":
            ...
            self.assertTrue(
                False,
                msg="MLURMSNorm input dtype only supports bfloat16, \
...
class TestMLUROPEFP16(TestMLUROPEFP32):
    def init_dtype(self):
        self.dtype = "float16"


class TestMLUROPERank1(TestMLUROPEFP32):
    def init_shape(self):
        # (B,S,N,D)
...
# class TestMLUROPEBF16(TestMLUROPEFP32):
#    def init_dtype(self):
#        self.dtype = "bfloat16"
#
#    def gen_input(self):
