...
class TestSyncBatchNormRunnerBase(object):
        ...
        while True:
            ...
            for ep in endpoints:
                ...
                with closing(
                    ...
                    sys.stderr.write("connect ip: {} port {}. result: {}\n".
                                     format(ip_port[0], ip_port[1], result))
                    if result != 0:
                        all_ok = False
    ...
    def initCommunicator(self, program, rank, nranks, wait_port,
        ...
        sys.stderr.write("current_ep: {}, other_ep: {}\n".format(
            current_endpoint, other_endpoints))
    ...
    def run_trainer(self, args):
        ...
        place = paddle.CustomPlace('CustomMLU', device_id)
        places = [place]
    ...
    def _cal_multiple_cards(self, args, data, place, layout, only_forward):
        ...
        nranks = 2
        sys.stderr.write("nranks: {}, rank: {}, endpoint: {}\n".format(
            nranks, rank, current_endpoint))
