...
# Usage:
# paddle_musa_parse_version_str(<library_name> <version_string>)
# cmake-format: on
function(paddle_musa_parse_version_str lib_name version_str)
...
# Return the MUSA arch flags, if not specified by PADDLE_MUSA_ARCH_LIST, then
# auto detect the arch of installed GPUs. Usage:
# paddle_musa_get_mcc_arch_list(output_var)
macro(paddle_musa_get_mcc_arch_list output_var)
  if(DEFINED ENV{PADDLE_MUSA_ARCH_LIST})
    set(_TMP $ENV{PADDLE_MUSA_ARCH_LIST})
  else()
    ...
    if(NOT MUSA_INFO_RESULT EQUAL 0)
      message(
        FATAL_ERROR
          "Could not detect MUSA arch of installed GPUs. try specifying the PADDLE_MUSA_ARCH_LIST env manually"
      )
    endif()
