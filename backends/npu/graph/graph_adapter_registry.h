...
USE_OP_ADAPTER(elementwise_mul);
USE_OP_ADAPTER(elementwise_mul_grad);
...
USE_OP_ADAPTER(transpose2);
USE_OP_ADAPTER(transpose2_grad);
USE_OP_ADAPTER(reshape2);
USE_OP_ADAPTER(reshape2_grad);
USE_OP_ADAPTER(sum);
USE_OP_ADAPTER(merged_momentum);
USE_OP_ADAPTER(check_finite_and_unscale);
USE_OP_ADAPTER(update_loss_scaling);
