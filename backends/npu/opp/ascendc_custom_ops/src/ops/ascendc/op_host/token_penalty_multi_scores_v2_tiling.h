...
namespace optiling {
BEGIN_TILING_DATA_DEF(TokenPenaltyMultiScoresV2TilingData)
...
TILING_DATA_FIELD_DEF(int32_t, badWLen);  // bad token length
TILING_DATA_FIELD_DEF(int32_t, reserve);  //
END_TILING_DATA_DEF;

REGISTER_TILING_DATA_CLASS(TokenPenaltyMultiScoresV2, TokenPenaltyMultiScoresV2TilingData)
}