...
from .remove_pass import remove_fused_bias_residual_layernorm, remove_rebuild_padding, remove_get_padding_offset, remove_get_token_penalty_multi_scores, save_with_output_delay_pass
...
def addPasses(pass_builder, model_type):
    if model_type == "llama7B_mp8_dynamic_batch":
        ...
        register_pass(pass_builder, "save_with_output_delay_pass")
