...
from .remove_pass import (remove_fused_bias_residual_layernorm, remove_rebuild_padding, remove_get_padding_offset,
                          remove_get_token_penalty_multi_scores, save_with_output_delay_pass_1st, save_with_output_delay_pass_2nd,
                          remove_get_max_len)
...
def addPasses(pass_builder, model_type):
    if model_type == "llama7B_mp8_dynamic_batch":
        ...
        register_pass(pass_builder, "llama_lmhead_quant")
        register_pass(pass_builder, "replace_embeding")
        register_pass(pass_builder, "remove_get_max_len")
