...
def addPasses(pass_builder, model_type, quant_type):
    if model_type == "llama" and quant_type == "a8w8":
        register_pass(pass_builder, "remove_fused_bias_residual_layernorm_residual")
        register_pass(pass_builder, "remove_rms_norm_residual")
        register_pass(pass_builder, "llama_fuse_ptq_attention_layer_begin")
        register_pass(pass_builder, "llama_fuse_ptq_attention_layer_end")
        register_pass(pass_builder, "llama_fuse_ptq_attention_layer")
