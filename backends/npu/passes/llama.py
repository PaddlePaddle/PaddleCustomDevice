...
@ir.RegisterPass
def remove_fused_bias_residual_layernorm_residual():
...
@ir.RegisterPass
def llama_fuse_ptq_attention_layer_begin():
    def pattern(
        input_ids,
        embedding_weight,
        norm_weight,
...
@ir.RegisterPass
def llama_fuse_ptq_attention_layer_end():
    def pattern(
        hidden_state,
        norm_weight,
        qkv_weight,
...
@ir.RegisterPass
def llama_fuse_ptq_attention_layer():
    def pattern(
        hidden_state,
        norm_weight,
        qkv_weight,
