...
std::vector<paddle::Tensor> ReluForward(const paddle::Tensor& x) {
  if (x.is_cpu()) {
    ...
    std::cout << "Debug info: run custom relu npu forward." << std::endl;
...
std::vector<paddle::Tensor> ReluBackward(const paddle::Tensor& x,
  ...
  if (x.is_cpu()) {
    ...
    std::cout << "Debug info: run custom relu npu backward." << std::endl;
...
std::vector<paddle::Tensor> ReluDoubleBackward(const paddle::Tensor& out,
  ...
  if (out.place() == paddle::PlaceType::kCPU) {
    ...
    std::cout << "Debug info: run custom npu double backward." << std::endl;
