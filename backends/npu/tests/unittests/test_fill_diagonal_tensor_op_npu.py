...
class TensorFillDiagTensorNPU(OpTest):
    def setUp(self):
    ...
    def test_check_grad(self):
        self.check_grad_with_place(
            self.place, ["X"], "Out", numeric_place=paddle.CPUPlace()
        )


class TensorFillDiagTensorNPUFp64(TensorFillDiagTensorNPU):
    def setUp(self):
        self.op_type = "fill_diagonal_tensor"
        self.python_api = paddle.tensor.manipulation.fill_diagonal_tensor
        self.set_npu()
...
class TensorFillDiagTensorNPUFP16(TensorFillDiagTensorNPU):
    def setUp(self):
        self.op_type = "fill_diagonal_tensor"
        self.python_api = paddle.tensor.manipulation.fill_diagonal_tensor
        self.set_npu()
