...
def getGridPointValue3D(data, x, y, z):
    ...
    out = np.zeros([N, C, out_D, out_H, out_W], dtype="float32")
    for i in range(N):
...
class Case2reflection(TestGridSamplerOp):
    def initTestCase(self):
        self.x_shape = (2, 3, 5, 6)
        self.grid_shape = (2, 8, 9, 2)
        self.theta_shape = (2, 2, 3)
...
class Case3border(TestGridSamplerOp):
    def initTestCase(self):
        self.x_shape = (2, 3, 5, 6)
        self.grid_shape = (2, 8, 9, 2)
        self.theta_shape = (2, 2, 3)
...
class Case4border(TestGridSamplerOp):
    def initTestCase(self):
        self.x_shape = (2, 3, 5, 6)
        self.grid_shape = (2, 8, 9, 2)
        self.theta_shape = (2, 2, 3)
...
class Case5with3D(TestGridSamplerOp):
    def initTestCase(self):
...
class Case6with3Dreflection(TestGridSamplerOp):
    def initTestCase(self):
        self.x_shape = (2, 3, 5, 6, 7)
        self.grid_shape = (2, 8, 9, 10, 3)
        self.theta_shape = (2, 3, 4)
...
class Case7with3Dborder(TestGridSamplerOp):
    def initTestCase(self):
        self.x_shape = (2, 3, 5, 6, 7)
        self.grid_shape = (2, 8, 9, 10, 3)
        self.theta_shape = (2, 3, 4)
...
class Case8with3Dnearest(TestGridSamplerOp):
    def initTestCase(self):
        self.x_shape = (2, 3, 5, 6, 7)
        self.grid_shape = (2, 8, 9, 10, 3)
        self.theta_shape = (2, 3, 4)
        ...
        self.padding_mode = "reflection"
        self.mode = "nearest"
        self.numeric_grad_delta = 1e-6


class Case9LargeInput(TestGridSamplerOp):
    def initTestCase(self):
...
class Case10LargeInput(TestGridSamplerOp):
    def initTestCase(self):
        self.x_shape = (2, 3, 128, 128)
        self.grid_shape = (2, 130, 130, 2)
        self.theta_shape = (2, 2, 3)
