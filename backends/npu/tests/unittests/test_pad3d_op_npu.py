...
class TestPad3dNPUOp(OpTest):
    def setUp(self):
        ...
        out = np.pad(
            self.inputs["X"], paddings, mode=self.mode, constant_values=self.value
        )
...
class TestPadAPI(unittest.TestCase):
    ...
    def test_static(self):
        ...
        with program_guard(Program(), Program()):
            ...
            result1 = F.pad(x=x, pad=pad, value=value, mode=mode, data_format="NCDHW")
            result2 = F.pad(x=x, pad=pad, value=value, mode=mode, data_format="NDHWC")
    ...
    def test_dygraph_2(self):
        ...
        y1 = F.pad(tensor_data, pad=pad, mode=mode, value=value, data_format="NCHW")
        y2 = F.pad(tensor_data, pad=pad, mode=mode, value=value, data_format="NHWC")
    ...
    def test_dygraph_3(self):
        ...
        y1 = F.pad(tensor_data, pad=pad, mode=mode, value=value, data_format="NCL")
        y2 = F.pad(tensor_data, pad=pad, mode=mode, value=value, data_format="NLC")
...
class TestPad1dAPI(unittest.TestCase):
    ...
    def test_class(self):
        ...
        np_out = self._get_numpy_out(
            input_data, [pad_int] * 2, "constant", value=value, data_format="NCL"
        )
        self.assertTrue(np.allclose(output.numpy(), np_out))
...
class TestPad2dAPI(unittest.TestCase):
    ...
    def test_class(self):
        ...
        output = pad_constant_int(data)
        np_out = self._get_numpy_out(
            input_data, [pad_int] * 4, "constant", value=value, data_format="NCHW"
        )
        self.assertTrue(np.allclose(output.numpy(), np_out))
...
class TestPad3dAPI(unittest.TestCase):
    ...
    def test_class(self):
        ...
        output = pad_constant_int(data)
        np_out = self._get_numpy_out(
            input_data, [pad_int] * 6, "constant", value=value, data_format="NCDHW"
        )
        self.assertTrue(np.allclose(output.numpy(), np_out))
