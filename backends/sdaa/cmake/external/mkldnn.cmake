...
# Introduce variables: * CMAKE_INSTALL_LIBDIR
...
include_directories(${MKLDNN_INC_DIR}) # For MKLDNN code to include internal
                                       # headers.
...
# copy the real so.0 lib to install dir it can be directly contained in wheel or
# capi
if(WIN32)
...
# generate a static dummy target to track mkldnn dependencies for cc_library(xxx
# SRCS xxx.c DEPS mkldnn)
