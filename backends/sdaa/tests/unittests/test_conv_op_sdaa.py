...
class TestWithPad2(TestConv2DOp_v2):
    def init_test_case(self):
        self.pad = [1, 1]
        self.stride = [1, 1]
        self.input_size = [2, 3, 5, 5]  # NCHW
...
class TestWithStride2(TestConv2DOp_v2):
    def init_test_case(self):
        self.pad = [1, 1]
        self.stride = [1, 1]
        self.input_size = [2, 3, 5, 5]  # NCHW
...
class TestWith1x1_2(TestConv2DOp_v2):
    def init_test_case(self):
        self.pad = [0, 0]
        self.stride = [1, 1]
        self.input_size = [2, 3, 5, 5]  # NCHW
...
class TestWithInput1x1Filter1x1_2(TestConv2DOp_v2):
    def init_test_case(self):
        self.pad = [0, 0]
        self.stride = [1, 1]
        self.input_size = [100, 1, 1, 1]  # NCHW
...
class TestConv2DOp_AsyPadding(TestConv2DOp_v2):
    # not supported, no request put up yet
    def init_paddings(self):
        self.pad = [0, 0, 1, 2]
        self.padding_algorithm = "EXPLICIT"
...
@unittest.skip("AsyPadding not supported, group conv has bug")
...
create_test_fp16_class(TestConv2DOp_v2)
create_test_fp16_class(TestWithPad2)
...
create_test_padding_SAME_class(TestWith1x1_2)
create_test_padding_SAME_class(TestWithInput1x1Filter1x1_2)

create_test_padding_VALID_class(TestWithPad2)
create_test_padding_VALID_class(TestWithStride2)
create_test_padding_VALID_class(TestWith1x1_2)
create_test_padding_VALID_class(TestWithInput1x1Filter1x1_2)

create_test_channel_last_class(TestWithPad2)
create_test_channel_last_class(TestWithStride2)
create_test_channel_last_class(TestWith1x1_2)
create_test_channel_last_class(TestWithInput1x1Filter1x1_2)
