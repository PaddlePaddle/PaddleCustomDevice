...
class TestMomentumOpWithDecay(OpTest):
    ...
    def test_check_output(self):
        paddle.enable_static()
        self.check_output_with_place(paddle.CustomPlace("sdaa", 0), atol=3e-3)
...
class TestMomentumOpVsMomentumOpWithDecayAPI(unittest.TestCase):
    ...
    def __test_vs(self, place=paddle.CustomPlace("sdaa", 0)):
    ...
    def test_vs(self, place=paddle.CustomPlace("sdaa", 0)):
